...
?>
				...
				<div class="row-fluid post">
					...
					<div class="col-sm-10 col-xs-9">
						...
						<div style="margin-left: auto; margin-right: auto;">
							<center>
							<a id="liewelive" href="https://www.youtube.com/watch?v=dNVZ0ZPfE8s">
				...
				<div class="row-fluid post">
					...
					<div class="col-sm-10 col-xs-9">
						<span>
							...
							<!--If you combat this by tailoring your newsfeed to suit your own thoughts and opinions,
							you become caught in a different feedback loop that only validates your pre-existing beliefs.-->
							<br/><br/>
							...
							TV reality in place. <!--By allowing Facebook manage how we interact, we're give up our
							autonomy and submitting to an algorithm.-->
							<br/><br/>
			...
			<div class="container-fluid">
				...
				<div class="col-sm-10 col-xs-9">
					<h2>Contact Us</h2>
					<span>
						If you have comments, questions, or suggestions for the programmers of this website, please email nojobsnomasters@tuta.io
						<br/><br/>
